...
class VodLibDB:
    ...
    def getDBVersion(self):
        return "0.9.3" # Table playlog_live added 
...
WHERE id = '""" + plid + """' """
    ...
    def writeNewPlaylist(self,plDictIn):
        createSQL = """INSERT INTO common_texts 
SET id = '""" + plDictIn['id'] + """', 
record_type = 'playlist', 
filt_crit_1 = '""" + plDictIn['clientid'] + """', 
filt_crit_2 = '', 
filt_crit_3 = '', 
create_date = NOW(), 
update_date = NOW(), 
...
record_data = '""" + json.dumps(plDictIn) + """' """
        ...
        result = self._stdInsert(createSQL)
...
class MediaLibraryDB:
    ...
    def getArtifactByIdNew(self,artiIdIn): # UPDATED FOR NEW RETURN OBJECT MODEL # Updated to use .cfg
        ...
        try:
            ...
            # Hard-coded for now.  Should be a .cfg option.
            print("MediaLibraryDB.getArtifactByIdNew - artiIdIn: " + artiIdIn + "; tmpRetObj: " + json.dumps(tmpRetObj))
